              ...
              <div class="card border-0 rounded-start-1 rounded-end-0">
                ...
                <div class="card-body">
                  ...
                  <div class="temperature-info special justify-content-between align-items-center">
                    ...
                    <img src="https:${list.current.condition.icon}" width="90" class="img-fluid" alt="${list.current.condition.text}">
                  </div>
                  ...
                  <div class="temperature-imgs d-flex gap-2 justify-content-between w-50 pt-4 pb-2">
                    <div class="img-one d-flex align-items-center gap-2">
                      <img width="25px" src="imgs/icon-umberella@2x.png" alt="umberella">
                      <p class="mb-0">20%</p>
                    </div>

                    <div class="img-one d-flex align-items-center gap-2">
                      <img width="25px" src="imgs/icon-wind@2x.png" alt="umberella">
                      <p class="mb-0">20%</p>
                    </div>

                    <div class="img-one d-flex align-items-center gap-2">
                      <img width="25px" src="imgs/icon-compass@2x.png" alt="umberella">
                      <p class="mb-0">20%</p>
                    </div>
                  </div>
                </div>
...
<div class="col-xl-4 weather-info rounded-0  px-0">
              <div class="card two border-0 rounded-0 text-center">
                ...
                <div class="card-body">
                  <div class="mt-4">
                    <img src="https:${list.forecast.forecastday[1].day.condition.icon}" width="40" class="img-fluid" alt="${list.forecast.forecastday[1].day.condition.text}">
                  </div>
 ...
 <div class="col-xl-4 weather-info  px-0">
              <div class="card  border-0 rounded-start-0 rounded-end-1 text-center">
                ...
                <div class="card-body">
                  <div class="mt-4">
                    <img src="https:${list.forecast.forecastday[2].day.condition.icon}" width="40" class="img-fluid" alt="${list.forecast.forecastday[2].day.condition.text}">
                  </div>
